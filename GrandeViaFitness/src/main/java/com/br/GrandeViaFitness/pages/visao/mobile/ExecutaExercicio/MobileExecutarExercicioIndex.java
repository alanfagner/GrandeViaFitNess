...
{
   public MobileExecutarExercicioIndex(final TipoExercicio tipoExercicio, final Date dataCadastro)
   {
      final RlPessoaExercicio auxPessoaExercicio = new RlPessoaExercicio();
      auxPessoaExercicio.setTipoExercicio(tipoExercicio);
      add(new MobileExecutarExercicioFrom(BasePage.FORMULARIO, auxPessoaExercicio, dataCadastro));
   }
