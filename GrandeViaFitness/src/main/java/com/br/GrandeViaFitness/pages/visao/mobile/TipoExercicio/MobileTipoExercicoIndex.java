...
public class MobileTipoExercicoIndex extends BasePageMobile
{
   ...
   public MobileTipoExercicoIndex(final Corpo corpo, final Date dataCadastro)
   {
      addOrReplace(new MobileTipoExercicoForm(BasePage.FORMULARIO, corpo, dataCadastro));
   }
